test_that("check function prepare_data_for_adepro:", {
 ...
 adae_data <- data.frame(
  ...
  testthat::expect_no_error(prepare_data_for_adepro(dat = adae_data[,-grep("DTHDT", colnames(adae_data))]))
...
test_that("check function prepare_data_for_adepro:", {
 ...
 adae_data <- data.frame(
    rbind(
       #subject 1234500 with no expected error/warning and 3 entries
       # "SUBJIDN", "AEDECOD", "AESTDY", "AEENDY", "AESEVN","AETRTEMN", "AESERN", "AERELN",  "TRT01A",        "TRTSDT",     "LVDT",  "DTHDT","SAFFN","AERELPRN","AEACNN"
       t(c(1234500,   "Pain",     2,        4,       1,       1,           0,       1,        "Trtmt",    "01JAN2010", "31DEC2010", NA,     1,      1,      1)),
       t(c(1234500,   "Pain",     6,        7,       1,       1,           0,       1,        "Trtmt",    "01JAN2010", "31DEC2010", NA,     1,      1,      1)),
       t(c(1234500,   "Headache", 10,       130,     1,       1,           0,       1,        "Trtmt",    "01JAN2010", "31DEC2010", NA,     1,      1,      1)),

       #subject 1234501 with no expected error/warning and 2 entries
       t(c(1234501,   "Pain",     2,        4,       1,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      0,      0)),
       t(c(1234501,   "Pain",     6,        7,       3,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      0,      0)),

       #subject 1234502 with no expected error/warning and 1 entries
       t(c(1234502,   "Headache", 1,        2,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),

       #subject 1234503 with no expected error/warning and 1 entries
       t(c(1234503,   "Headache", 1,        2,       2,       1,           0,       1,        "Trtmt",    "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),

       #subject 1234504 with safety flag 0
       t(c(1234504,   "Headache", 1,        2,       2,       1,           0,       1,        "Trtmt",    "01JAN2010", "31DEC2010", NA,     0,      NA,      NA)),

       #subject 1234505 with safety adverse event ended before day 1
       t(c(1234505,   "Headache", -7,        -2,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),
       t(c(1234505,   "Pain",     1,        2,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),

       ## warnings/error

       #subject 1234506 with missing start date
       t(c(1234506,   "Headache", 1,        2,       2,       1,           0,       1,        "Placebo",  NA,           "31DEC2010", NA,     1,      NA,      NA)),
       t(c(1234506,   "Pain",     1,        2,       2,       1,           0,       1,        "Placebo",  NA,           "31DEC2010", NA,     1,      NA,      NA)),
       ...
       #subject 1234508 with missing start date
       t(c(1234508,   "Headache", 1,        2,       2,       1,           0,       1,        "Placebo",  NA,           "31DEC2010", NA,     1,      NA,      NA)),
       t(c(1234508,   "Pain",     1,        2,       2,       1,           0,       1,        "Placebo",  NA,           "31DEC2010", NA,     1,      NA,      NA)),

       #subject 1234509 with missing ae start time
       t(c(1234509,   "Headache",NA,        2,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),
       t(c(1234509,   "Pain",    NA,        2,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),

       #subject 1234510 with non-unique row
       t(c(1234510,   "Headache",1,        2,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),
       t(c(1234510,   "Headache",1,        2,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),

       #subject 1234511 ae start day after ae end day
       t(c(1234511,   "Headache",3,        2,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),

       #subject 1234512 with missing ae end day
       t(c(1234512,   "Headache",1,        NA,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),

       #subject 1234513 with missing subject id
       t(c(NA     ,   "Headache",1,        2,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),

       #subject 1234514 with wrong ae severity grade
       t(c(1234514,   "Headache",1,        3,       10,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),

       #subject 1234515 with death date before trt start date
       t(c(1234515,   "Headache",1,        3,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", "01JAN2009",     1,      NA,      NA)),

       #subject 1234516 with wrong coding for ae related flag
       t(c(1234516,   "Headache",1,        3,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", "01JAN2009",     1,     3,      NA)),

       #subject 1234517 with ae start day and end day missing
       t(c(1234517,   "Headache",NA,        NA,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", "01JAN2009",     1,     3,      NA)),

       #subject 1234518 with ae start day and end day missing and ae code missing
       t(c(1234518,   NA ,NA,        NA,       2,       1,           0,       1,        "Trtmt",  "01JAN2010", "31DEC2010", "01JAN2009",     1,     3,      NA)),

       #subject 1234519 with no expected error/warning and 1 entries
       t(c(1234519,   NA, 1,        2,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),

       #subject 1234502 with no expected error/warning and 1 entries
       t(c(1234520,   "", 1,        2,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),

       #subject 1234521 with no expected error/warning and 1 entries
       t(c(1234521,   "Headache", 10,        2,       2,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      NA,      NA)),

       #subject 1234522 with missing severity grades
       t(c(1234522,   "Pain",     2,        4,       NA,       1,           0,       1,        "Trtmt",    "01JAN2010", "31DEC2010", NA,     1,      1,      1)),
       t(c(1234522,    NA,     6,        7,       NA,       1,           0,       1,        "Trtmt",    "01JAN2010", "31DEC2010", NA,     1,      1,      1)),
       t(c(1234522,   "Headache", 10,       130,     1,       1,           0,       1,        "Trtmt",    "01JAN2010", "31DEC2010", NA,     1,      1,      1)),

       #subject 1234523 with missing severity grades
       t(c(1234523,   "",     2,        4,       NA,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      0,      0)),
       t(c(1234523,   "Pain",     6,        7,       5,       1,           0,       1,        "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      0,      0))
 ...
 adsl_data <- data.frame(
    rbind(
      #subject 1234500
       # "SUBJIDN",  "TRT01A",        "TRTSDT",     "LVDT",  "DTHDT","SAFFN", "REGION", "SEX", "AGE")
       t(c(1234500,  "Trtmt",    "01JAN2010", "31DEC2010", NA,     1,      "Europe",   "M",   20)),

      #subject 1234501
       t(c(1234501, "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      "Europe",   "M",   20)),

       #subject 1234502 with different TRT01A than in adae
       t(c(1234502,  "Trtmt",  "01JAN2010",  "31DEC2010", NA,     1,      "Europe",   "M",   20)),

       #subject 1234503 different/missing TRTSDT than in adae
       t(c(1234503,  "Trtmt",    NA,          "31DEC2010", NA,     1,      "Europe",   "M",   60)),

       #subject 1234504
       t(c(1234504,  "Trtmt",   "01JAN2010", "31DEC2010", NA,     0,      "Europe",   "M",   20)),

       #subject 1234505
       t(c(1234505, "Placebo",  "01JAN2010", "31DEC2010", NA,     1,       "Europe",   "M",   50)),

       #subject 1234506 set subjid to missing
       t(c(NA,  "Placebo",      NA,           "31DEC2010", NA,     1,       "Europe",   "M",   20)),

       #subject 1234507
       t(c(1234507, "Placebo",  NA,           NA,           NA,     1,     "Europe",   "F",   20)),

       #subject 1234508
       t(c(1234508, "Placebo",  NA,           "31DEC2010", NA,     1,     "Europe",   "M",   40)),

       #subject 1234509
       t(c(1234509, "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      "Europe",   "M",   20)),

       #subject 1234510
       t(c(1234510, "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      "Europe",   "F",   20)),

       #subject 1234511
       t(c(1234511, "Placebo",  "01JAN2010", "31DEC2010", NA,     1,       "Europe",   "M",   20)),

       #subject 1234512
       t(c(1234512, "Placebo",  "01JAN2010", "31DEC2010", NA,     1,     "Europe",   "M",   20)),

       #subject 1234513 add subject id
       t(c(1234513, "Placebo",  "01JAN2010", "31DEC2010", NA,     1,       "Europe",   "M",   30)),

       #subject 1234514
       t(c(1234514, "Placebo",  "01JAN2010", "31DEC2010", NA,     1,      "Europe",   "F",   20)),

       #subject 1234515
       t(c(1234515, "Placebo",  "01JAN2010", "31DEC2010", "01JAN2009", 1,     "Europe",   "M",   20)),

       #subject 1234516
       t(c(1234516,  "Placebo",  "01JAN2010", "31DEC2010", "01JAN2009", 1,    "Europe",   "M",   20)),

       #subject 1234522 with missing severity grades
       t(c(1234522,   "Trtmt",    "01JAN2010", "31DEC2010",       NA,  1,     "Asia",   "F",   30)),

       #subject 1234523 with missing severity grades
       t(c(1234523,    "Placebo",     "01JAN2010", "31DEC2010", NA, 1,    "Europe",   "F",   40))
